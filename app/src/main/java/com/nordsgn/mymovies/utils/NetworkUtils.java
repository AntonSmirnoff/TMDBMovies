package com.nordsgn.mymovies.utils;
...
public class NetworkUtils {
    ...
    private static final String API_KEY = "968cc510c0a5d6ab3759a383de575d8d";
 //   private static final String LANGUAGE_VALUE = "ru-RU";
    ...
    public static URL buildURLToReviews(int id, String lang) {
        Uri uri = Uri.parse(String.format(BASE_URL_REVIEWS, API_KEY)).buildUpon()
